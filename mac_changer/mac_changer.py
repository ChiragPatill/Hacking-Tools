...
def get_arguments():
	...
	if not options.interface:
		parse.error("[-] Pleace specify an interface, use --help or more info.")
	elif not options.new_mac:
		parse.error("[-] please specify a new_mac, use --help or more info.")
	return options
...
if Get_current_mac==options.new_mac:
	print("[+] MAC address has been sucessfully changed to "+Get_current_mac)
else:
